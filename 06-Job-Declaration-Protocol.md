...
| coinbase_output                     | B0_64K    | Bitcoin transaction outputs added by the pool                                                                                                                                                                                                                                                                                                                               |
...
| coinbase_prefix             | B0_64K                 | The coinbase transaction nVersion field                                                                                                                                                                                                                                                                                                                                                                                       |
| coinbase_suffix             | B0_64K                 | Up to 8 bytes (not including the length byte) which are to be placed at the beginning of the coinbase field in the coinbase transaction                                                                                                                                                                                                                                                                                      |
...
| version                                 | U32       | Header version field                                                                                                                                                                                                                                                                       |
