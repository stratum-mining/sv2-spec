...
This repository contains the Stratum V2 protocol specification.
 ...
 - [4. Protocol Security](./04-Protocol-Security.md#4-protocol-security)
  ...
  - [4.5. Authenticated Key Agreement Handshake](./04-Protocol-Security.md#45-authenticated-key-agreement-handshake)
    - [4.5.1. NX-handshake part 1 `-> e`](./04-Protocol-Security.md#451-nx-handshake-part-1---e)
      - [4.5.1.1. Initiator](./04-Protocol-Security.md#4511-initiator)
      - [4.5.1.2. Responder](./04-Protocol-Security.md#4512-responder)
    - [4.5.2. NX-handshake part 2 `<- e, ee, s, es`](./04-Protocol-Security.md#452-nx-handshake-part-2---e-ee-s-es)
  ...
  - [4.8. Key Management and Rotation](./04-Protocol-Security.md#48-key-management-and-rotation)
    - [4.8.1. Static and ephemeral key rotation](./04-Protocol-Security.md#481-static-and-ephemeral-key-rotation)
    - [4.8.2. Custody of the authority private key](./04-Protocol-Security.md#482-custody-of-the-authority-private-key)
    - [4.8.3. Certificate validity](./04-Protocol-Security.md#483-certificate-validity)
    - [4.8.4. Rotating the authority key](./04-Protocol-Security.md#484-rotating-the-authority-key)
    - [4.8.5. Multiple authority keys](./04-Protocol-Security.md#485-multiple-authority-keys)
    - [4.8.6. Failed certificate verification](./04-Protocol-Security.md#486-failed-certificate-verification)
  - [4.9. References](./04-Protocol-Security.md#49-references)
